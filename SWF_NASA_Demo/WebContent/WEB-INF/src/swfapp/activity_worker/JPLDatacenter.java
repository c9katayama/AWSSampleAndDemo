...
public interface JPLDatacenter {

	String fileTransfer(String srcImagePath);

	CombineResult combineResult(ProcessingResultA resultA,
			ProcessingResultB resultB, ProcessingResultD resultD);

	void showResult(CombineResult result);
